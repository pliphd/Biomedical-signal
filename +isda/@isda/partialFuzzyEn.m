function en = partialFuzzyEn(this, varargin)
% PARTIALFUZZYEN calculate partial fuzzy entropy for an ISDA object
% 
% $Author:  Peng Li
% $Date:    Dec 04, 2020
% 
...
% init
if nargin == 1
    error('THRESHOLD is required to calculate partial fuzzy entropy.');
end
...
% prob @ m
cm = sum(exp(-log(2).*(this.InterStateDistance./rValue).^2))*2 ...
...
% prob @ m+1
ca = sum(exp(-log(2).*(thism1.InterStateDistance./rValue).^2))*2 ...
